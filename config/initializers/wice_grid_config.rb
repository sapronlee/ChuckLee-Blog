if defined?(Wice::Defaults)
  ...
  Wice::Defaults::FILTER_ICON = '/images/icons/grid/table_refresh.png'

  # Icon to reset the filter.
  Wice::Defaults::RESET_ICON = "/images/icons/grid/table.png"
  ...
  Wice::Defaults::DELETE_QUERY_ICON = '/images/icons/grid/delete.png'
